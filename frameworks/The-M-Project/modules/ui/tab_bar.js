...
/** @scope M.TabBarView.prototype */ {
    ...
    /**
     * 3/26/13: WLS change for KIVA
     * Allows selection of tab even if it is already set to currentTab. Useful if there
     * is a setup where one navigates to a different page through a tab, so currentTab may not
     * show what the current page is. By default this is set to YES.
     *
     * @type Boolean
     */
     alwaysSwitch: YES,
