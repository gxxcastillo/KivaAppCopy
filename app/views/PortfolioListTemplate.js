...
//
// Project: KivaApp
// View: PortfolioListTemplate
// ==========================================================================

KivaApp.PortfolioListTemplate = M.ListItemView.design({
// tap event that takes use to Loan Item page for selected Borrower
    ...
    ,photo: M.GridView.design({
        ...
        ,right_col: M.ContainerView.design({
            childViews: 'name location use loan_amount lender_amount'
            ...
            ,lender_amount: M.LabelView.design({
                computedValue: {
                    valuePattern: '<%= past_loan_details %>'
                    ,operation: function(past_loan_details){
                        return "My Loan: " + KivaApp.LoanItemController.formatMoney(past_loan_details.lent_amount);
                    }
                }    
            })
        })
